...
export default function NotificationBell() {
  ...
  const { unreadCount, initializeSocket, disconnectSocket, loadNotificationsFromBackend } = useNotificationStore();
  ...
  }, [isAuthenticated, user, initializeSocket, disconnectSocket, loadNotificationsFromBackend]);
